...
class SigninsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signin" do
    assert_difference('Signin.count') do
      post signins_url, params: { signin: { company: @signin.company, name: @signin.name, purpose: @signin.purpose } }
    end
  ...
  test "should update signin" do
    patch signin_url(@signin), params: { signin: { company: @signin.company, name: @signin.name, purpose: @signin.purpose } }
